...
<article class="site-container py-10 max-w-3xl">
    <nav class="breadcrumb mb-6" aria-label="Konum">
    ...
    <h1 class="text-3xl font-bold text-iw-text">{{ $guide['title'] }}</h1>
    <p class="text-iw-text-muted mt-3 leading-relaxed">{{ $guide['body'] }}</p>
