...
<section class="border-b border-iw-border bg-iw-deep">
    <div class="max-w-[1200px] mx-auto px-6 py-8">
        ...
        <div class="flex gap-2 overflow-x-auto no-scrollbar pb-1">
            @foreach([
                ['Fırsat Ürünleri', 'orange', 'deal', 'M13 10V3L4 14h7v7l9-11h-7z'],
                ['Çok Satanlar', 'yellow', 'bestseller', 'M11.049 2.927c.3-.921 1.603-.921 1.902 0l1.519 4.674a1 1 0 00.95.69h4.915c.969 0 1.371 1.24.588 1.81l-3.976 2.888a1 1 0 00-.363 1.118l1.518 4.674c.3.922-.755 1.688-1.538 1.118l-3.976-2.888a1 1 0 00-1.176 0l-3.976 2.888c-.783.57-1.838-.197-1.538-1.118l1.518-4.674a1 1 0 00-.363-1.118l-3.976-2.888c-.784-.57-.38-1.81.588-1.81h4.914a1 1 0 00.951-.69l1.519-4.674z'],
                ...
                ['Hediye Fikirleri', 'yellow', 'gift', 'M14.752 11.168l-3.197-2.132A1 1 0 0010 9.87v4.263a1 1 0 001.555.832l3.197-2.132a1 1 0 000-1.664z'],
            ] as [$title, $tone, $slug, $icon])
            <a href="{{ route('products.index', ['filtre' => $slug]) }}" class="filter-chip filter-chip--{{ $tone }}">
