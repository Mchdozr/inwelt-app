        ...
        <div class="site-container py-12 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div>
                ...
                <ul class="space-y-2 text-sm text-iw-text-muted">
                    ...
                    @endphp
                    <li>
                        <a href="{{ \App\Support\WhatsApp::url() }}" target="_blank" rel="noopener noreferrer" class="inline-flex items-center gap-2 hover:text-emerald-600 transition-colors no-underline" data-track-whatsapp="footer">
